...
img_background = mypath + 'background.jpg'
img_racket = mypath + 'racket.png'
img_ball = mypath + 'tennis_ball.png'
...
while True:
    ...
    if game_state == 'start':
        ...
        window.blit(small_font.render(f"P2: {score2}", True, black), (600, 50))

    elif game_state == 'gameover':
        result_text = main_font.render("GAME OVER!", True, red)
        window.blit(result_text, (70, 130))
        winner = "DRAW! NICE TRY."
        if score1 > score2:
